...
class UserProfile(models.Model):
    ...
    job = models.ForeignKey(Job, verbose_name="職業", on_delete=models.CASCADE, null=True)
    gender = models.CharField("性別", max_length=2, choices=GENDER_CHOICES, null=True)
    trigger = models.ForeignKey(Trigger, verbose_name="きっかけ", on_delete=models.CASCADE, null=True)
    purpose = models.ForeignKey(Purpose, verbose_name="目的", on_delete=models.CASCADE, null=True)
